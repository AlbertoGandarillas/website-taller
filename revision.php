...
<div class="page-wrapper">
    ...
    <section class="page-title" style="background-image:url(images/background/8.jpg);">
        <div class="auto-container">
            <div class="inner-container clearfix">
                <h1>CONSULTAS DE TRABAJOS REALIZADOS</h1>
    ...
    <section class="services-page-section">
        <div class="auto-container">
            <center><H2><H2>TRABAJOS REALIZADOS A SU VEHICULO</H2></H2>
		<br>
		<br></center>
            <div class="row clearfix">
            <?php
				$RPTListaDatos = new logica();
				$RQTListaDatos = $RPTListaDatos->Listar_Imagenes($_SESSION['DNI'],$_SESSION['PLACA']);
				for ($i = 0; $i < sizeof($RQTListaDatos); $i++) {

                    if (isset($RQTListaDatos[$i]["IMG_NOMBRE1"])){
			?>
                <!-- Service Block -->
                <div class="service-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure><img src="class/<?php echo $RQTListaDatos[$i]["IMG_RUTA1"]; ?>" alt=""></figure>
                            <div class="title"><h4><?php echo $RQTListaDatos[$i]["FECHA_CREACION"]; ?></h4></div>
                        </div>
                        <div class="caption-box">
                            <div class="title-box">
                                <span class="icon flaticon-pistons"></span>
                                <h4><a href="#"><?php echo $RQTListaDatos[$i]["IMG_NOMBRE1"]; ?></a></h4>
                            </div>
                            <p><?php echo $RQTListaDatos[$i]["IMG_DESCRIPCION1"]; ?></p>
            ...
            <?php 
                    ...
                    if (isset($RQTListaDatos[$i]["IMG_NOMBRE2"])){ 
            ?>
                <!-- Service Block -->
                <div class="service-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure><img src="class/<?php echo $RQTListaDatos[$i]["IMG_RUTA2"]; ?>" alt=""></figure>
                            <div class="title"><h4><?php echo $RQTListaDatos[$i]["FECHA_CREACION"]; ?></h4></div>
                        </div>
                        <div class="caption-box">
                            <div class="title-box">
                                <span class="icon flaticon-pistons"></span>
                                <h4><a href="#"><?php echo $RQTListaDatos[$i]["IMG_NOMBRE2"]; ?></a></h4>
                            </div>
                            <p><?php echo $RQTListaDatos[$i]["IMG_DESCRIPCION2"]; ?></p>
            ...
            <?php 
                    ...
                    if (isset($RQTListaDatos[$i]["IMG_NOMBRE3"])){ 
            ?>               
                <!-- Service Block -->
                <div class="service-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure><img src="class/<?php echo $RQTListaDatos[$i]["IMG_RUTA3"]; ?>" alt=""></figure>
                            <div class="title"><h4><?php echo $RQTListaDatos[$i]["FECHA_CREACION"]; ?></h4></div>
                        </div>
                        <div class="caption-box">
                            <div class="title-box">
                                <span class="icon flaticon-pistons"></span>
                                <h4><a href="#"><?php echo $RQTListaDatos[$i]["IMG_NOMBRE3"]; ?></a></h4>
                            </div>
                            <p><?php echo $RQTListaDatos[$i]["IMG_DESCRIPCION3"]; ?></p>
